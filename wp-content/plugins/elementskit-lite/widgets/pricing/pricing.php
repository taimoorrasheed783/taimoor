        ...
        $this->add_control(
            ...
            [
                ...
                'options'   => [
                    ...
                    'disc'          => esc_html__( 'Disc', 'elementskit' ),
                    'decimal'       => esc_html__( 'Number', 'elementskit' ),
                    'lower-alpha'   => esc_html__( 'Alphabet', 'elementskit' ),
                    'lower-roman'   => esc_html__( 'Roman', 'elementskit' ),
                ],
                'selectors' => [
